...
import QualifyNow from '../lead generation/QualifyNow';
...
// const handleClickQualifyNow =()=>{
//   setShowQualifyNow(true);
//   setShowContact(false);
//   setShowHeadding(false);
...
<Div  sx={{display:showContact=== true ? "block":"none"}}>
          ...
          <TableBody>
            {rows.map((row) => (
              ...
              >
                ...
                <TableCell align="center" sx={{whiteSpace:"nowrap",fontSize:"14px",textAlign:"left"}}>{row.Location}</TableCell>
                <TableCell align="left"  onClick={() => navigate("/leads/Qualify")}
                  sx={{ cursor: "pointer" }}>
      ...
      {/* <Div  sx={{display:showQualifyNow=== true ? "block":"none"}}>
        <QualifyNow/>
      </Div> */}
    </JumboContentLayoutMain>
