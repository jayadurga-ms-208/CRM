...
// import CampaignRightSideCardList from "../campaign-right-side-card/CampaignRightSideCardList";
import Heading from "../lead generation/Heading";
...
// import QualifySocial from "../lead generation/QualifySocial";
import {
  BarChartOutlined,
  CancelOutlined,
  CheckBox,
...
import ViewContact from "../leads-right-side-card/List page/ViewContact";
...
const LeadsLeftSide = () => {
  const [showPendingLeadsRight, setshowPendingLeadsRight] = useState(false);
  ...
  return (
    <>
      <Card sx={{backgroundColor:"rgba(212, 241, 244, 0.5);",p:1}}>
        <Grid container spacing={1}>
          <Grid item xs={3} margin={1}>
            <Card sx={{ boxShadow: "none",backgroundColor:"rgba(212, 241, 244, 0.5);" }}>
              <Card className="border-card" sx={{ p: 3, borderRadius: "20px", boxShadow: " 0px 4px 4px rgba(0, 0, 0, 0.25)", maxWidth: "350px" ,backgroundColor:"white"}}>
                <Div
                  sx={{
                    display: "flex",
                ...
                >
                  ...
                  <Typography variant="h3" sx={{ paddingLeadsLeftSide: "8px", m: 0 }}>
                ...
                <Grid container>
                  <Grid item xs={6}>
                    <Typography align="LeadsLeftSide" sx={{ fontWeight: 600 }}>
              ...
              <Card className="border-card" sx={{ mt: 1, p: 0, borderRadius: "20px", boxShadow: " 0px 4px 4px rgba(0, 0, 0, 0.25)", maxWidth: "350px" }}>
                <Div
                  sx={{
                    p: 0,
                    pb: 0,
                ...
                <Div
                  ...
                  sx={{
                    ...
                    p: 1,
                    pb: 0.5,
                    backgroundColor: showAllLeadsList ? "rgba(212, 241, 244, 0.7);" : "#fff",
                    cursor: "pointer",
                  }}
                >
                  <Typography variant="h5" sx={{ fontWeight: 600, pl: 2 }}>
                ...
                <Div
                  ...
                  sx={{
                    ...
                    p: 1,
                    pb: 0.5,
                    backgroundColor: showLeadsWebPage ? "rgba(212, 241, 244, 0.7);" : "#fff",
                    cursor: "pointer",
                  }}
                >
                  <Typography variant="h5" sx={{ fontWeight: 600, pl: 2 }}>
              ...
              <Card className="border-card" sx={{ mt: 1, mb: 1, p: 1, borderRadius: "20px", boxShadow: " 0px 4px 4px rgba(0, 0, 0, 0.25)", maxWidth: "350px" }}>
                <Div
                  sx={{
                    p: 1,
                    pb: 0.5,
          ...
          <Grid
            item
            xs={8}
            sx={{ display: showAllign == true ? "block" : "none" }}
          >
            <Allign />
          </Grid>
          <Grid
            item
            xs={8}
            sx={{ display: showAllLeadsList == true ? "block" : "none" ,backgroundColor:"white",p:3}}
          >
            <>
              <Grid container>
                <Grid items xs={9}>
                ...
                <Table sx={{ minWidth: 550 }} aria-label="simple table">
                  <TableHead>
                    <TableRow sx={{ bgcolor: "#1B416B" }}>
                      ...
                      <TableCell sx={{ color: "#FEFEFE", fontSize: "15px", whiteSpace: "nowrap" }} align="center">
                        Lead Stage
                        <ArrowUpwardIcon fontSize="small" />
                      </TableCell>
                      <TableCell sx={{ color: "#FEFEFE", fontSize: "15px", whiteSpace: "nowrap" }} align="center">
                  ...
                  <TableBody>
                    {rows.map((row) => (
                      ...
                      >
                        <TableCell
                          onClick={handleClickViewContact}
                          sx={{ cursor: "pointer" }}
                        >
                          <Div
                            sx={{
                          ...
                          >
                            ...
                            <Typography variant="h4" paddingLeft="12px" sx={{ fontSize: "12px", whiteSpace: "nowrap" }}>
                              {row.accName}
                              <br />
                              <span
                                style={{ color: "#475259", fontSize: "10px" }}
                              >
                                {row.desig}
                              </span>
                            </Typography>
                        ...
                        <TableCell align="center" sx={{ whiteSpace: "nowrap", fontSize: "12px" }}>
                          <WifiCalling3Icon
                            sx={{ paddingRight: "4px", color: "#007BFF" }}
                          />
                          {row.phone}
                        </TableCell>
                        <TableCell sx={{ color: "#304995", whiteSpace: "nowrap" }} align="center">
                          <EmailIcon
                            sx={{ paddingRight: "4px", color: "#007BFF" }}
                          />
                          {row.email}
          ...
          <Grid
            item
            xs={8}
            sx={{ display: showLeadsWebPage == true ? "block" : "none", backgroundColor:"white" }}
          >
            <Heading />
          </Grid>
          <Grid
            item
            xs={8}
            sx={{ display: showViewContact == true ? "block" : "none" }}
          >
            <ViewContact />
          </Grid>
          <Grid item xs={8} sx={{ display: showPendingLeadsRight == true ? "block" : "none" }}>
            <PendingLeadsRight />
          </Grid>
          <Grid item xs={8} sx={{ display: showAssignLeadsRight == true ? "block" : "none" }}>
            <AssignLeadsRight />
          </Grid>
          <Grid item xs={8} sx={{ display: showUnAssignLeadsRight == true ? "block" : "none" }}>
            <UnAssignLeadsRight />
          </Grid>
          <Grid item xs={8} sx={{ display: showUnTouchedLeadsRight == true ? "block" : "none" }}>
            <UnTouchedLeadsRight />
          </Grid>
        </Grid>
      </Card>
