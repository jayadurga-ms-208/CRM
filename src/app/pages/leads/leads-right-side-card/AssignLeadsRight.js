...
const AssignLeadsRight = () => {

  // Table function and values

  const BarStyle = { width: "10rem", height: "10rem", background: "#F0F0F0", padding: "0.5rem", float: "right" };
  function createData(bcolor, accName, desig, phone, email, country, city, leads) {
    return { bcolor, accName, desig, phone, email, country, city, leads };
  }
    ...
    <Card  sx={{backgroundColor:"white",margin:1,padding:2}}>
      ...
      <Grid container spacing={2}>
        ...
        <Dialog
          ...
          <Typography variant="h3" sx={{ paddingLeft: "8px", m: 0 }}><b>Assigned Leads</b></Typography>
          <br />
        </Grid>
      </Grid>
      <Grid item xs={3}>
          ...
          <TableBody>
            {rows.map((row) => (
              ...
              >
                ...
                <TableCell align="center" sx={{ whiteSpace: "nowrap" }}>{row.leads}</TableCell>
...
export default AssignLeadsRight