    ...
    <Card sx={{backgroundColor:"white",margin:1,padding:2}}>
      ...
      <Grid container spacing={2}>
        <Grid item xs={6}>
          ...
          <Typography variant="h3" sx={{ paddingLeft: "8px", m: 0 }}><b>Pending Leads To Qualify</b></Typography>
          <br></br>
        </Grid>
        <Grid item xs={3}>
        </Grid>
              ...
              >
                ...
                >
                  <Div sx={{ display: "flex", justifyContent: "flex-start" }}>
                    ...
                    <Typography variant="h4" paddingLeft="12px" sx={{ color: "#304995", whiteSpace: "nowrap", }}>
                      {row.accName}
                      <br />
                ...
                <TableCell align="center" sx={{ whiteSpace: "nowrap" }}>{row.country}</TableCell>
                <TableCell align="center" sx={{ whiteSpace: "nowrap" }}>{row.city}</TableCell>
                <TableCell align="center" sx={{ whiteSpace: "nowrap" }}>{row.status}</TableCell>
...
export default PendingLeadsRight