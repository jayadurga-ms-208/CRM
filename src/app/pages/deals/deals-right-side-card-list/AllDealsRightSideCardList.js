...
const AllDealsRightSideCardList = () => {
...
<Grid container spacing={2} >
        <Grid item xs={6} onClick={handleCreateAccount}>
          ...
          <br/>
          <br/>
          <Typography  sx={{ paddingLeft: "8px", m: 0, fontSize:"14px" }}>All Deals</Typography>
          <br/>
        </Grid>
...
export default AllDealsRightSideCardList