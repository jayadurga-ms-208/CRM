...
const NewDealsRightSideCardList = () => {
...
<Grid container spacing={2}>
        ...
        <Typography variant="contained"  sx={{
          ...
          <br/>
          <br/>
          <Typography sx={{ paddingLeft: "8px", m: 0,fontSize:"14px" }}>New Deals</Typography>
          <br/>
        </Grid>
...
              />
        ...
        <br/>
          ...
          <Button variant="outlined" sx={{ paddingRight: "30px",mb:1 }}>This Week <KeyboardArrowDownIcon/></Button>
          <br/>
        </Grid>
        <br/>
    </Grid>
            ...
            <Table sx={{ minWidth: 1300 }} aria-label="simple table">
              <TableHead>
                <TableRow sx={{ bgcolor: '#1B416B' }}>
                  <TableCell sx={{ color: '#FEFEFE' }} align="center">Account Name<ArrowUpwardIcon/></TableCell>
              ...
              <TableBody>
                ...
                >
                  ...
                  <Typography variant="h5" sx={{ fontWeight: 600, pl:2,fontSize:"14px",color:"#304995" }}>
                    {row.name}<br/><span style={{fontWeight: 500,fontSize:"12px",color:"black"}}>{row.des}</span>
                  </Typography>
                </Div>
                    </TableCell>
...
export default NewDealsRightSideCardList
