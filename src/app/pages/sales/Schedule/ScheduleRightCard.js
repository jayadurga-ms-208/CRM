...
import {
  Autocomplete, Button, Card, Checkbox, Dialog, DialogActions,
...
import SchedulePendingShipments from '../Schedule/SchedulePendingShipments';
...
const ScheduleRightCard = () => {
  ...
  const handlePendingShipments = () => {
    ...
    setshowSchedulePendingShipments(true);
    setActive(!active);
  }

  const handleRightCard = () => {
    setshowScheduledRightCard(true);
    setshowSchedulePendingShipments(false);
    setActive(!active);
  }
  ...
  return (
    <Card sx={{backgroundColor:"white", py:2,px:1}}>
      <Grid container>
        <Grid item xs={9}>
          ...
          >
            ...
            <br></br>
            <DialogContent sx={{backgroundColor: "#8D77BE80"}}>
              <Card className='border-card' sx={{borderRadius: 5}}>
              ...
              <Card className='border-card' sx={{borderRadius: 5}}>
                ...
                <Grid container className="border-card" sx={{ background: "#FEFFEA", p: 2, borderRadius: 5 }}>
                  ...
                  <Grid item sx={{ p: '3px', paddingRight: '20px' }}>
                    ...
                    <Typography sx={{ fontWeight: 600, textAlign:"center" }}>30</Typography>
                  </Grid>
                  <Grid item sx={{ p: '1px', paddingRight: '20px' }}>
                    <Typography sx={{ color: "#7D7D7D" }}>Available Quantity</Typography>
                    <Typography sx={{ fontWeight: 600, textAlign:"center"  }}>100</Typography>
                  </Grid>
                  <Grid item sx={{ p: '1px', paddingRight: '20px' }}>
                    <Typography sx={{ color: "#7D7D7D" }}>Schedule Quantity</Typography>
                    <Typography sx={{ fontWeight: 600, textAlign:"center"  }}>25</Typography>
                  </Grid>
                  <Grid item sx={{ p: '1px', paddingRight: '20px' }}>
        ...
        <Grid item xs>
          <Grid container paddingBottom={2} direction="row" columnSpacing={1.5}>
            ...
            <Button
                ...
                size="small"
                variant={showSchedulePendingShipments ? "contained" : "text"}
                sx={{
                  height: "33px",
                  minwidth: "140px",
                  ":hover": {
                  ...
                  backgroundColor: showSchedulePendingShipments ? "#EFDCF9" : "#fff",
                  color: showSchedulePendingShipments ? "#CD2A1C" : "black",
                }}
              >
                Pending Shipments
              </Button>
        ...
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 550 }} aria-label="simple table">
            ...
            <TableBody>
              ...
              >
                <MenuItem onClick={handleClickEditSales}><ModeEdit sx={{ fontSize: 20, mr: 2 }} />Edit</MenuItem>
      ...
      <Div sx={{ display: showSchedulePendingShipments === true ? "block" : "none" }}>
